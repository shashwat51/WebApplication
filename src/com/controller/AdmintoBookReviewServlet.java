...
/**
 * Servlet implementation class AdmintoBookReviewServlet
 */
@WebServlet("/AdmintoBookReviewServlet")
public class AdmintoBookReviewServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdmintoBookReviewServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		result = search.getBookDetails();
		session = request.getSession();
		session.setAttribute("resultList", result);
		url = "/AdminBookReview.jsp";
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int book_id=Integer.parseInt(request.getParameter("Book_idtoReview"));

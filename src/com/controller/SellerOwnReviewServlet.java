...
/**
 * Servlet implementation class SellerOwnReviewServlet
 */
@WebServlet("/SellerOwnReviewServlet")
public class SellerOwnReviewServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SellerOwnReviewServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//System.out.print("Seller Id from  Search result jsp"+seller_id);
		System.out.print(user.getUser_id());
		
		result_order_no = search.findSellerReviewid(user.getUser_id());
